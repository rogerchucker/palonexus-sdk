...
| jaraco-classes | 3.4.0 | MIT | reviewed | Retain notices | None identified | PyPI |
| jaraco-context | 6.1.2 | MIT | reviewed | Retain notices | None identified | PyPI |
| jaraco-functools | 4.6.0 | MIT | reviewed | Retain notices | None identified | PyPI |
| jeepney | 0.9.0 | MIT | reviewed | Retain notices | None identified | PyPI |
| keyring | 25.7.0 | MIT | reviewed | Retain notices | None identified | PyPI |
...
| more-itertools | 11.1.0 | MIT | reviewed | Retain notices | None identified | PyPI |
...
| pywin32-ctypes | 0.2.3 | BSD-3-Clause | reviewed | Retain supplied license | None supplied | PyPI |
...
| rfc3339-validator | 0.1.4 | MIT | reviewed | Retain notices | None identified | PyPI |
| rfc8785 | 0.1.4 | Apache-2.0 | reviewed | Retain supplied license | None supplied | PyPI |
...
| secretstorage | 3.5.0 | BSD-3-Clause | reviewed | Retain supplied license | None supplied | PyPI |
| six | 1.17.0 | MIT | reviewed | Retain notices | None identified | PyPI |
